(function (global) {
    ...
    // Constructor
    function KeyShotXR(containerId, config) {
    ...
    // Initialization
    KeyShotXR.prototype.init = function () {
    ...
    // Preload Images
    KeyShotXR.prototype.preloadImages = function () {
    ...
    // Get Image Path
    KeyShotXR.prototype.getImagePath = function (u, v) {
        return `${this.folderPath}${v}_${u}.${this.imageExtension}`;
    };

    // Render Image
    KeyShotXR.prototype.renderImage = function () {
    ...
    // Handle Mouse Drag
    KeyShotXR.prototype.handleDrag = function (deltaX, deltaY) {
    ...
    // Add Event Listeners
    KeyShotXR.prototype.addEventListeners = function () {
